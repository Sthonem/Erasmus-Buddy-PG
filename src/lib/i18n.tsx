...
const translations = {
  ...
  "place.armata.note": { en: "Bring your friends, grab a drink, enjoy the vibe. The unofficial Thursday tradition for students in Wrzeszcz.", tr: "Arkadaşlarını getir, bir içecek al, ortamın tadını çıkar. Wrzeszcz öğrencilerinin resmi olmayan Perşembe geleneği.", es: "Trae a tus amigos, toma algo y disfruta del ambiente. La tradición no oficial de los jueves para estudiantes en Wrzeszcz.", pl: "Weź znajomych, napij się czegoś i ciesz się atmosferą. Nieoficjalna czwartkowa tradycja studentów we Wrzeszczu." },
