...
const translations = {
  ...
  "place.armata.note": { en: "Bring your friends, try Flanki (a traditional Polish outdoor game), grab a drink and enjoy the vibe. The unofficial Thursday tradition for students in Wrzeszcz.", tr: "Arkadaşlarını getir, Flanki oyna (geleneksel Polonya açık hava oyunu), bir içecek al ve ortamın tadını çıkar. Wrzeszcz öğrencilerinin resmi olmayan Perşembe geleneği.", es: "Trae a tus amigos, juega Flanki (un juego tradicional polaco al aire libre), toma algo y disfruta del ambiente. La tradición no oficial de los jueves para estudiantes en Wrzeszcz.", pl: "Weź znajomych, zagraj we Flanki, napij się czegoś i ciesz się atmosferą. Nieoficjalna czwartkowa tradycja studentów we Wrzeszczu." },
