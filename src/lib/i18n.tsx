...
const translations = {
  ...
  "dashboard.studentLife": { en: "Student Life & Events", tr: "Öğrenci Hayatı & Etkinlikler", es: "Vida Estudiantil y Eventos", pl: "Życie Studenckie i Wydarzenia" },
  "dashboard.followForEvents": { en: "Follow for events & parties", tr: "Etkinlikler ve partiler için takip et", es: "Síguelos para eventos y fiestas", pl: "Śledź wydarzenia i imprezy" },
  "esn.gdansk.title": { en: "ESN Gdańsk", tr: "ESN Gdańsk", es: "ESN Gdańsk", pl: "ESN Gdańsk" },
  "esn.gdansk.desc": { en: "Erasmus events, trips & parties in Gdańsk", tr: "Gdańsk'ta Erasmus etkinlikleri, geziler ve partiler", es: "Eventos Erasmus, viajes y fiestas en Gdańsk", pl: "Wydarzenia Erasmus, wycieczki i imprezy w Gdańsku" },
  "esn.gdansk.tag": { en: "@esn_gdansk", tr: "@esn_gdansk", es: "@esn_gdansk", pl: "@esn_gdansk" },
  "esn.3city.title": { en: "ESN 3City", tr: "ESN 3City", es: "ESN 3City", pl: "ESN 3City" },
  "esn.3city.desc": { en: "Tri-city Erasmus community & events", tr: "Üç şehir Erasmus topluluğu ve etkinlikleri", es: "Comunidad Erasmus de las tres ciudades", pl: "Trójmiejska społeczność Erasmus i wydarzenia" },
  "esn.3city.tag": { en: "@esn3city", tr: "@esn3city", es: "@esn3city", pl: "@esn3city" },
  "esn.pg.title": { en: "ESN GUT Official", tr: "ESN GUT Resmi", es: "ESN GUT Oficial", pl: "ESN GUT Oficjalnie" },
  "esn.pg.desc": { en: "Official PG student organization page", tr: "Resmi PG öğrenci organizasyonu sayfası", es: "Página oficial de la organización estudiantil PG", pl: "Oficjalna strona organizacji studenckiej PG" },
  "esn.pg.tag": { en: "pg.edu.pl", tr: "pg.edu.pl", es: "pg.edu.pl", pl: "pg.edu.pl" },
  ...
  "guide.sis.s2d": { en: "Visit: sis.eti.pg.edu.pl (ETI faculty only — check your faculty for their SIS link)", tr: "Ziyaret: sis.eti.pg.edu.pl (sadece ETI fakültesi — kendi fakültenin SIS linkini kontrol et)", es: "Visita: sis.eti.pg.edu.pl (solo facultad ETI — consulta el enlace SIS de tu facultad)", pl: "Odwiedź: sis.eti.pg.edu.pl (tylko wydział ETI — sprawdź link SIS swojego wydziału)" },
  ...
  "place.kwadratowa.note": { en: "Register on Facebook before 20:00 & enter before 22:00 = FREE with student ID. Otherwise: students 20 PLN, regular 40 PLN. Bring your student ID!", tr: "Facebook'tan 20:00'den önce kayıt ol ve 22:00'den önce gir = öğrenci kimliğiyle ÜCRETSİZ. Aksi halde: öğrenci 20 PLN, normal 40 PLN. Öğrenci kimliğini yanına al!", es: "Regístrate en Facebook antes de las 20:00 y entra antes de las 22:00 = GRATIS con carné de estudiante. Si no: estudiantes 20 PLN, normal 40 PLN. ¡Lleva tu carné!", pl: "Zarejestruj się na Facebooku przed 20:00 i wejdź przed 22:00 = ZA DARMO z legitymacją. W przeciwnym razie: studenci 20 PLN, normalny 40 PLN. Weź legitymację!" },
  "places.everyThursday": { en: "Every Thursday", tr: "Her Perşembe", es: "Cada Jueves", pl: "Każdy Czwartek" },
  "place.armata.detail": { en: "Outdoor student hangout near campus — Thursdays are the night", tr: "Kampüs yakını açık hava buluşma noktası — Perşembeler gece başlar", es: "Punto de encuentro al aire libre cerca del campus — Los jueves son la noche", pl: "Plenerowe miejsce spotkań studentów — Czwartki to ta noc" },
  "place.armata.note": { en: "Bring your friends, try Flanki — a traditional Polish outdoor game, grab a drink and enjoy the vibe. The unofficial Thursday tradition for students in Wrzeszcz.", tr: "Arkadaşlarını getir, geleneksel Polonya açık hava oyunu Flanki'yi dene, bir içecek al ve ortamın tadını çıkar. Wrzeszcz öğrencilerinin resmi olmayan Perşembe geleneği.", es: "Trae a tus amigos, prueba Flanki — un juego tradicional polaco al aire libre, toma algo y disfruta del ambiente. La tradición no oficial de los jueves para estudiantes en Wrzeszcz.", pl: "Weź znajomych, zagraj we Flanki, napij się czegoś i ciesz się atmosferą. Nieoficjalna czwartkowa tradycja studentów we Wrzeszczu." },
  ...
  // ── Dashboard explore card titles ──
  "explore.sopot.title": { en: "Sopot Pier", tr: "Sopot Sahili", es: "Muelle de Sopot", pl: "Molo w Sopocie" },
  "explore.dlugi.title": { en: "Długi Targ", tr: "Długi Targ", es: "Długi Targ", pl: "Długi Targ" },
  "explore.oliwa.title": { en: "Oliwa Park", tr: "Oliwa Parkı", es: "Parque Oliwa", pl: "Park Oliwski" },
  "explore.hel.title": { en: "Hel Peninsula", tr: "Hel Yarımadası", es: "Península de Hel", pl: "Półwysep Helski" },
  "explore.wester.title": { en: "Westerplatte", tr: "Westerplatte", es: "Westerplatte", pl: "Westerplatte" },
  "explore.gdynia.title": { en: "Gdynia Waterfront", tr: "Gdynia Sahili", es: "Paseo Marítimo de Gdynia", pl: "Nabrzeże Gdyni" },
  // Dashboard eats titles
  "eats.pierogi.title": { en: "Pierogarnia Mandu", tr: "Pierogarnia Mandu", es: "Pierogarnia Mandu", pl: "Pierogarnia Mandu" },
  "eats.biedronka.title": { en: "Biedronka", tr: "Biedronka", es: "Biedronka", pl: "Biedronka" },
  "eats.kebab.title": { en: "Kebab spots", tr: "Kebapçılar", es: "Puestos de Kebab", pl: "Kebaby" },
  "eats.stacja.title": { en: "Stacja Food Hall", tr: "Stacja Yemek Hali", es: "Stacja Food Hall", pl: "Stacja Food Hall" },

  // ── Place names & notes ──
  // Campus
  "place.intl-office": { en: "International Students Office", tr: "Uluslararası Öğrenci Ofisi", es: "Oficina de Estudiantes Internacionales", pl: "Biuro Studentów Międzynarodowych" },
  "place.intl-office.detail": { en: "Main Building, Room 124", tr: "Ana Bina, Oda 124", es: "Edificio Principal, Sala 124", pl: "Budynek Główny, Pokój 124" },
  "place.intl-office.note": { en: "Your first stop — English-speaking staff. Handles enrollment, OLA, EHIC.", tr: "İlk durağın — İngilizce konuşan personel. Kayıt, OLA, EHIC işlemleri.", es: "Tu primera parada — personal de habla inglesa. Gestiona matrícula, OLA, EHIC.", pl: "Twój pierwszy przystanek — anglojęzyczny personel. Obsługuje zapisy, OLA, EHIC." },
  "place.deans-office": { en: "Welcome Office", tr: "Karşılama Ofisi", es: "Oficina de Bienvenida", pl: "Biuro Powitalne" },
  "place.deans-office.detail": { en: "Building 10 — Main Campus", tr: "Bina 10 — Ana Kampüs", es: "Edificio 10 — Campus Principal", pl: "Budynek 10 — Kampus Główny" },
  "place.deans-office.note": { en: "Student ID cards, enrollment certificates, course issues.", tr: "Öğrenci kimlik kartları, kayıt belgeleri, ders sorunları.", es: "Carnés de estudiante, certificados de matrícula, problemas de cursos.", pl: "Legitymacje studenckie, zaświadczenia o zapisie, sprawy przedmiotowe." },
  "place.library": { en: "Library", tr: "Kütüphane", es: "Biblioteca", pl: "Biblioteka" },
  "place.library.note": { en: "Access with student ID. Study rooms, printing, scanning.", tr: "Öğrenci kimliğiyle giriş. Çalışma odaları, baskı, tarama.", es: "Acceso con carné. Salas de estudio, impresión, escaneo.", pl: "Dostęp z legitymacją. Sale do nauki, drukowanie, skanowanie." },
  "place.dorms": { en: "Student Dormitories (DS1–DS6)", tr: "Öğrenci Yurtları (DS1–DS6)", es: "Residencias Estudiantiles (DS1–DS6)", pl: "Akademiki (DS1–DS6)" },
  "place.dorms.detail": { en: "ul. Wyspiańskiego, on-campus", tr: "ul. Wyspiańskiego, kampüs içi", es: "ul. Wyspiańskiego, en el campus", pl: "ul. Wyspiańskiego, na kampusie" },
  "place.dorms.note": { en: "Present booking + passport at reception.", tr: "Resepsiyonda rezervasyon + pasaport göster.", es: "Presenta reserva + pasaporte en recepción.", pl: "Okaż rezerwację + paszport w recepcji." },
  "place.it-help": { en: "IT Help Desk", tr: "BT Yardım Masası", es: "Soporte IT", pl: "Pomoc IT" },
  "place.it-help.note": { en: "PG email, Eduroam Wi-Fi, Microsoft 365.", tr: "PG e-posta, Eduroam Wi-Fi, Microsoft 365.", es: "Email PG, Eduroam Wi-Fi, Microsoft 365.", pl: "E-mail PG, Eduroam Wi-Fi, Microsoft 365." },
  "place.finance": { en: "Finance Office (Grants)", tr: "Mali İşler Ofisi (Burslar)", es: "Oficina Financiera (Becas)", pl: "Biuro Finansowe (Stypendia)" },
  "place.finance.detail": { en: "Main Building, 1st Floor", tr: "Ana Bina, 1. Kat", es: "Edificio Principal, 1er Piso", pl: "Budynek Główny, 1. piętro" },
  "place.finance.note": { en: "Erasmus grant payments. Bring Polish bank details.", tr: "Erasmus burs ödemeleri. Polonya banka bilgilerini getir.", es: "Pagos de beca Erasmus. Trae datos bancarios polacos.", pl: "Wypłaty stypendium Erasmus. Weź dane polskiego konta." },
  // Groceries
  "place.biedronka.detail": { en: "ul. Partyzantów 71 & many locations", tr: "ul. Partyzantów 71 ve birçok şube", es: "ul. Partyzantów 71 y más ubicaciones", pl: "ul. Partyzantów 71 i wiele lokalizacji" },
  "place.biedronka.note": { en: "Most affordable. Closest to PG. Open 6:00–23:00.", tr: "En uygun fiyatlı. PG'ye en yakın. 6:00–23:00 arası açık.", es: "Más económico. Más cercano a PG. Abierto 6:00–23:00.", pl: "Najtańszy. Najbliżej PG. Czynny 6:00–23:00." },
  "place.lidl.detail": { en: "ul. Kartuska 245 & others", tr: "ul. Kartuska 245 ve diğerleri", es: "ul. Kartuska 245 y otros", pl: "ul. Kartuska 245 i inne" },
  "place.lidl.note": { en: "Great fresh produce, bakery and weekly deals.", tr: "Harika taze ürünler, fırın ve haftalık fırsatlar.", es: "Excelentes productos frescos, panadería y ofertas semanales.", pl: "Świeże produkty, piekarnia i cotygodniowe promocje." },
  "place.kaufland.note": { en: "Large hypermarket — best for big weekly shop.", tr: "Büyük hipermarket — haftalık büyük alışveriş için ideal.", es: "Gran hipermercado — ideal para la compra semanal grande.", pl: "Duży hipermarket — najlepszy na duże zakupy tygodniowe." },
  "place.zabka.detail": { en: "Literally every 10 meters. You can't escape it.", tr: "Her 10 metrede bir var. Kaçış yok.", es: "Literalmente cada 10 metros. No puedes escapar.", pl: "Dosłownie co 10 metrów. Nie uciekniesz." },
  "place.zabka.note": { en: "Poland's unofficial landmark. Open 6:00–23:00, perfect for last-minute everything.", tr: "Polonya'nın resmi olmayan simgesi. 6:00–23:00 arası açık, son dakika her şey için.", es: "El monumento no oficial de Polonia. Abierto 6:00–23:00, perfecto para todo de último momento.", pl: "Nieoficjalny symbol Polski. Czynne 6:00–23:00, idealne na wszystko na ostatnią chwilę." },
  // Transport
  "place.ztm": { en: "ZTM — Trams & Buses", tr: "ZTM — Tramvay & Otobüs", es: "ZTM — Tranvías y Autobuses", pl: "ZTM — Tramwaje i Autobusy" },
  "place.ztm.note": { en: "Buy tickets on board or in-app. Validate immediately!", tr: "Biletleri araçta veya uygulamadan al. Hemen doğrula!", es: "Compra billetes a bordo o en la app. ¡Valida inmediatamente!", pl: "Kup bilety na pokładzie lub w aplikacji. Skasuj od razu!" },
  "place.skm": { en: "SKM — City Rail", tr: "SKM — Şehir Treni", es: "SKM — Tren Urbano", pl: "SKM — Kolej Miejska" },
  "place.skm.note": { en: "Sopot in 12 min, Gdynia in 25 min. Wrzeszcz station 10 min from PG.", tr: "Sopot'a 12 dk, Gdynia'ya 25 dk. Wrzeszcz istasyonu PG'den 10 dk.", es: "Sopot en 12 min, Gdynia en 25 min. Estación Wrzeszcz a 10 min de PG.", pl: "Sopot w 12 min, Gdynia w 25 min. Stacja Wrzeszcz 10 min od PG." },
  "place.discount": { en: "Student Discount — 50%", tr: "Öğrenci İndirimi — %50", es: "Descuento Estudiante — 50%", pl: "Zniżka Studencka — 50%" },
  "place.discount.detail": { en: "Show student ID", tr: "Öğrenci kimliğini göster", es: "Muestra carné de estudiante", pl: "Pokaż legitymację" },
  "place.discount.note": { en: "ZTM and SKM both offer 50% off. Essential!", tr: "ZTM ve SKM'de %50 indirim. Çok önemli!", es: "ZTM y SKM ofrecen 50% de descuento. ¡Esencial!", pl: "ZTM i SKM oferują 50% zniżki. Niezbędne!" },
  "place.taxi.detail": { en: "Taxi apps on iOS & Android", tr: "iOS ve Android taksi uygulamaları", es: "Apps de taxi en iOS y Android", pl: "Aplikacje taxi na iOS i Android" },
  "place.taxi.note": { en: "Cheaper than traditional taxis. Avoid unmarked cabs.", tr: "Geleneksel taksilerden ucuz. İşaretsiz taksilerden kaçın.", es: "Más baratos que taxis tradicionales. Evita taxis sin licencia.", pl: "Tańsze niż tradycyjne taksówki. Unikaj nieoznakowanych." },
  // Pharmacy
  "place.drmax.note": { en: "Largest chain. Most meds OTC. Some English staff.", tr: "En büyük zincir. Çoğu ilaç reçetesiz. Bazı personel İngilizce bilir.", es: "Cadena más grande. Mayoría de meds sin receta. Algo de personal en inglés.", pl: "Największa sieć. Większość leków OTC. Część personelu mówi po angielsku." },
  "place.24h-pharmacy": { en: "24h Emergency Pharmacy", tr: "7/24 Nöbetçi Eczane", es: "Farmacia de Emergencia 24h", pl: "Apteka Całodobowa" },
  "place.24h-pharmacy.note": { en: "Open around the clock for emergencies.", tr: "Acil durumlar için 7/24 açık.", es: "Abierta las 24 horas para emergencias.", pl: "Otwarta całą dobę na nagłe przypadki." },
  // City
  "place.old-town": { en: "Stare Miasto — Old Town", tr: "Stare Miasto — Eski Şehir", es: "Stare Miasto — Casco Antiguo", pl: "Stare Miasto" },
  "place.old-town.detail": { en: "~20 min by tram", tr: "Tramvayla ~20 dk", es: "~20 min en tranvía", pl: "~20 min tramwajem" },
  "place.old-town.note": { en: "Stunning architecture, restaurants, bars. Długi Targ is the heart.", tr: "Muhteşem mimari, restoranlar, barlar. Długi Targ kalbidir.", es: "Arquitectura impresionante, restaurantes, bares. Długi Targ es el corazón.", pl: "Oszałamiająca architektura, restauracje, bary. Długi Targ to serce." },
  "place.baltycka.note": { en: "Largest mall near PG — H&M, Zara, food court. 5-min walk.", tr: "PG'ye en yakın AVM — H&M, Zara, yemek alanı. 5 dk yürüyüş.", es: "Centro comercial más grande cerca de PG — H&M, Zara, zona de comidas. 5 min a pie.", pl: "Największe centrum handlowe blisko PG — H&M, Zara, food court. 5 min pieszo." },
  "place.forum.detail": { en: "City centre", tr: "Şehir merkezi", es: "Centro de la ciudad", pl: "Centrum miasta" },
  "place.forum.note": { en: "Modern mall — cinema, IKEA Pick-Up, great food hall.", tr: "Modern AVM — sinema, IKEA Pick-Up, harika yemek alanı.", es: "Centro comercial moderno — cine, IKEA Pick-Up, excelente zona de comidas.", pl: "Nowoczesne centrum — kino, IKEA Pick-Up, świetny food hall." },
  // Food
  "place.canteen": { en: "PG Student Canteen", tr: "PG Öğrenci Yemekhanesi", es: "Comedor Estudiantil PG", pl: "Stołówka Studencka PG" },
  "place.canteen.detail": { en: "On campus — Gmach B", tr: "Kampüste — Gmach B", es: "En el campus — Gmach B", pl: "Na kampusie — Gmach B" },
  "place.canteen.note": { en: "Hot meals 12–20 PLN. Cheapest on campus.", tr: "Sıcak yemekler 12–20 PLN. Kampüsteki en ucuz.", es: "Comidas calientes 12–20 PLN. Lo más barato del campus.", pl: "Ciepłe posiłki 12–20 PLN. Najtańsze na kampusie." },
  "place.milkbar": { en: "Bar Mleczny (Milk Bar)", tr: "Bar Mleczny (Süt Barı)", es: "Bar Mleczny (Bar de Leche)", pl: "Bar Mleczny" },
  "place.milkbar.detail": { en: "Various locations", tr: "Çeşitli lokasyonlar", es: "Varias ubicaciones", pl: "Różne lokalizacje" },
  "place.milkbar.note": { en: "Traditional Polish canteen. Pierogi, barszcz 10–25 PLN.", tr: "Geleneksel Polonya yemekhane. Pierogi, barszcz 10–25 PLN.", es: "Comedor tradicional polaco. Pierogi, barszcz 10–25 PLN.", pl: "Tradycyjny bar mleczny. Pierogi, barszcz 10–25 PLN." },
  "place.coffee": { en: "Coffee Shops", tr: "Kafeler", es: "Cafeterías", pl: "Kawiarnie" },
  "place.coffee.detail": { en: "Wrzeszcz neighbourhood", tr: "Wrzeszcz mahallesi", es: "Barrio Wrzeszcz", pl: "Dzielnica Wrzeszcz" },
  "place.coffee.note": { en: "Karma Coffee, Sowa, Coffeedesk — great cafés near campus.", tr: "Karma Coffee, Sowa, Coffeedesk — kampüs yakınında harika kafeler.", es: "Karma Coffee, Sowa, Coffeedesk — excelentes cafés cerca del campus.", pl: "Karma Coffee, Sowa, Coffeedesk — świetne kawiarnie blisko kampusu." },
  // Emergency
  "place.112": { en: "Emergency — 112", tr: "Acil Durum — 112", es: "Emergencia — 112", pl: "Numer Alarmowy — 112" },
  "place.112.detail": { en: "European emergency number", tr: "Avrupa acil durum numarası", es: "Número de emergencia europeo", pl: "Europejski numer alarmowy" },
  "place.112.note": { en: "Works from any phone. English operators available.", tr: "Her telefondan çalışır. İngilizce operatör mevcuttur.", es: "Funciona desde cualquier teléfono. Operadores en inglés disponibles.", pl: "Działa z każdego telefonu. Dostępni operatorzy anglojęzyczni." },
  "place.uck.note": { en: "Main hospital. Emergency (SOR) open 24/7.", tr: "Ana hastane. Acil servis (SOR) 7/24 açık.", es: "Hospital principal. Urgencias (SOR) abierto 24/7.", pl: "Główny szpital. SOR otwarty 24/7." },
  "place.nfz": { en: "NFZ GP Clinic", tr: "NFZ Aile Hekimi", es: "Clínica NFZ", pl: "Przychodnia NFZ" },
  "place.nfz.detail": { en: "Register after ZUS", tr: "ZUS'tan sonra kayıt ol", es: "Regístrate después de ZUS", pl: "Zarejestruj się po ZUS" },
  "place.nfz.note": { en: "Free GP visits with ZUS insurance + PESEL.", tr: "ZUS sigortası + PESEL ile ücretsiz doktor ziyareti.", es: "Visitas médicas gratuitas con seguro ZUS + PESEL.", pl: "Bezpłatne wizyty u lekarza z ubezpieczeniem ZUS + PESEL." },

  // ── Reset password page ──
  "reset.title": { en: "New Password", tr: "Yeni Şifre", es: "Nueva Contraseña", pl: "Nowe Hasło" },
  "reset.subtitle": { en: "Choose a strong password for your account", tr: "Hesabın için güçlü bir şifre seç", es: "Elige una contraseña segura para tu cuenta", pl: "Wybierz silne hasło do swojego konta" },
  "reset.verifying": { en: "Verifying reset link…", tr: "Sıfırlama linki doğrulanıyor…", es: "Verificando enlace…", pl: "Weryfikowanie linku…" },
  "reset.newPassword": { en: "New password (min 6 characters)", tr: "Yeni şifre (min 6 karakter)", es: "Nueva contraseña (mín 6 caracteres)", pl: "Nowe hasło (min 6 znaków)" },
  "reset.confirm": { en: "Confirm new password", tr: "Yeni şifreyi onayla", es: "Confirmar nueva contraseña", pl: "Potwierdź nowe hasło" },
  "reset.submit": { en: "Set New Password", tr: "Yeni Şifreyi Belirle", es: "Establecer Nueva Contraseña", pl: "Ustaw Nowe Hasło" },
  "reset.updating": { en: "Updating…", tr: "Güncelleniyor…", es: "Actualizando…", pl: "Aktualizowanie…" },
  "reset.mismatch": { en: "Passwords don't match.", tr: "Şifreler eşleşmiyor.", es: "Las contraseñas no coinciden.", pl: "Hasła nie pasują." },
  "reset.tooShort": { en: "Password must be at least 6 characters.", tr: "Şifre en az 6 karakter olmalıdır.", es: "La contraseña debe tener al menos 6 caracteres.", pl: "Hasło musi mieć co najmniej 6 znaków." },
