...
const translations = {
  ...
  "place.kwadratowa.note": { en: "Register on Facebook before 20:00 & enter before 22:00 = FREE (students only). Otherwise: students 20 PLN, regular 40 PLN. Don't forget your student ID!", tr: "Facebook'tan 20:00'den önce kayıt ol ve 22:00'den önce gir = ÜCRETSİZ (sadece öğrenciler). Aksi halde: öğrenci 20 PLN, normal 40 PLN. Öğrenci kimliğini unutma!", es: "Regístrate en Facebook antes de las 20:00 y entra antes de las 22:00 = ¡GRATIS (solo estudiantes)! Si no: estudiantes 20 PLN, normal 40 PLN. ¡No olvides tu carné de estudiante!", pl: "Zarejestruj się na Facebooku przed 20:00 i wejdź przed 22:00 = ZA DARMO (tylko studenci). W przeciwnym razie: studenci 20 PLN, normalny 40 PLN. Nie zapomnij legitymacji!" },
